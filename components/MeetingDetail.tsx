    ...
    return (
        <div className="bg-white shadow-lg rounded-xl border border-gray-200 p-8 max-w-4xl mx-auto print:shadow-none print:border-none">
            ...
            <div className="border-b border-gray-200 pb-6 mb-6 text-center">
                ...
                <h2 className="text-3xl font-extrabold text-gray-900">Ward Sacrament Program</h2>
            ...
            {meeting.announcements && meeting.announcements.length > 0 && (
                <div className="mb-6 bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                    <h4 className="font-bold text-blue-900 text-sm uppercase tracking-wide mb-1">Announcements</h4>
            ...
            <div className="space-y-4 text-gray-800">
                <div className="flex justify-between border-b pb-2">
                    <span className="font-semibold">Opening Hymn (No. {meeting.openingHymn.number}):</span>
                ...
                <div className="flex justify-between border-b pb-2">
                    <span className="font-semibold">Ward Business:</span>
                    <span>
                ...
                <div className="flex justify-between border-b pb-2">
                    <span className="font-semibold">Sacrament Hymn (No. {meeting.sacramentHymn.number}):</span>
                    <span>{meeting.sacramentHymn.title}</span>
                </div>
                <div className="py-2">
                    <h4 className="font-semibold text-gray-900 mb-2">Speakers & Musical Numbers:</h4>
                    <ul className="space-y-2 pl-4">
                        {meeting.speakers.map((speaker, idx) => (
                            <li key={idx} className="text-sm bg-gray-50 p-2 rounded flex justify-between">
                                <span><strong className="text-gray-900">{speaker.name}</strong> {speaker.topic ? `— "${speaker.topic}"` : ''}</span>
                ...
                <div className="flex justify-between border-b pb-2 pt-2">
                    <span className="font-semibold">Closing Hymn (No. {meeting.closingHymn.number}):</span>
